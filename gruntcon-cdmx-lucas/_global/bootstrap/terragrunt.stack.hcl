...
stack "bootstrap" {
  ...
  values = {
    ...
    aws_account_id = "445816555701"

    oidc_resource_prefix = "pipelines"

    github_org_name  = "lv201"
    ...
    // =========================================================================
    oidc_provider_import_arn = "arn:aws:iam::445816555701:oidc-provider/token.actions.githubusercontent.com"
    plan_iam_role_import_existing = true
    plan_iam_policy_import_arn = "arn:aws:iam::445816555701:policy/pipelines-plan"
    plan_iam_role_policy_attachment_import_arn = "pipelines-plan/arn:aws:iam::445816555701:policy/pipelines-plan"
    apply_iam_role_import_existing = true
    apply_iam_policy_import_arn = "arn:aws:iam::445816555701:policy/pipelines-apply"
    apply_iam_role_policy_attachment_import_arn = "pipelines-apply/arn:aws:iam::445816555701:policy/pipelines-apply"
    // =========================================================================
